...
def evaluate():
    ...
    for test_attack_limit in test_attack_limits:
        ...
        for test_penalty in test_interdiction_penalties:
            ...
            for n, m in test_settings:
                ...
                for rep in range(reps_per_setting):
                    ...
                    sample = solve_instance(G=G, s=s, t=t,density=density,
                        attack_limit=test_attack_limit, interdiction_penalty=test_penalty)
                    ...
                    predicted_objective = shortest_path_after_attack(sample,
                    ...
                    results_rows.append({"n_nodes": n,
                        ...
                        "replication": rep,
                        "attack_limit": k,
                        "interdiction_penalty": test_penalty,
            ...
            print(f"\nFINAL TEST RESULTS FOR K={test_attack_limit}, penalty={test_penalty}")
